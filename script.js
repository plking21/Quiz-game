...
function showResult(){
    ...
    if (userScore === questions.length) { // Max Score
        let scoreTag = '<span> Wow! You got max score <p>' +userScore+ '</p> out of <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
        maxScoreSound.play(); // Play the max score sound
    } else if (userScore === 0) { // Zero Score
        let scoreTag = '<span>Sorry, You got <p>' +userScore+ '</p> out of <p>' + questions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
        zeroScoreSound.play(); // Play the zero score sound
    } else if (userScore > 7) {
...
// Update the optionSelected function to play sounds
function optionSelected(answer) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    creditsBox.addEventListener("click", function () {
        creditsBox.classList.toggle("open");
    });
});
